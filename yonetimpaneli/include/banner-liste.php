                                ...
                                if ($veriler!=false)
                                {
                                    ...
                                    for ($i=0;$i<count($veriler);$i++)
                                    {
                                        ...
                                        <tr>
                                            <td><?= $sira ?></td>
                                            <td>
                                                <img src="<?=ANASITE?>images/banner/<?=$veriler[$i]["resim"]?>" style="width: auto;height: 60px; margin-right: 8px; float: left;" alt="">
                                            ...
                                            <td><a href="<?=SITE?>banner-duzenle/<?=$veriler[$i] ["ID"]?>" class="btn btn-warning btn-sm">Düzenle</a>
                                                <a href="<?=SITE?>banner-sil/<?=$veriler[$i] ["ID"]?>" class="btn btn-danger btn-sm">Kaldır</a></td>
                                        </tr>
                                        <?php
                                    }
                                }
