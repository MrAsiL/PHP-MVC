                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th style="width: 200px;height:auto;">Resim</th>
                                    ...
                                    for ($i=0;$i<count($veriler);$i++)
                                    {
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>   <img src=" <?=ANASITE?>yuklenenimages/<?=$veriler[$i] ["resim"]?>" alt="" style="width: 200px;" > </td>
                                                    <td><?=$veriler[$i] ["tarih"]?></td>
                                                    <td><a href="<?=SITE?>duzenle/<?=$kontrol[0] ["tablo"]?>/<?=$veriler[$i] ["ID"]?>" class="btn btn-warning btn-sm">Düzenle</a>
                                                    <a href="<?=SITE?>sil/<?=$kontrol[0] ["tablo"]?>/<?=$veriler[$i] ["ID"]?>" class="btn btn-danger btn-sm">Kaldır</a></td>
                                                </tr>
                                             <?php
                                    }
                                }
